...
| Concern                   | File                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Viewer side of the bridge | `viewer/extensions/scoring-bridge/src/bridge.ts` (composition root), `messaging.ts` (origin check, posting, command routing), `handshake.ts` (`VIEWER_READY`), `measurementStream.ts` (the three subscriptions), `reportedMeasurements.ts` (`uid ↔ rowId`, throttled updates), `commands.ts`, `removals.ts`, `focus.ts`, `measurements.ts`, `throttle.ts`, `getCustomizationModule.tsx`, `restore.ts` (RESTORE_MEASUREMENTS, readiness gate, re-adding annotations), `geometry.ts` |
...
| Host side of the bridge   | `host-app/src/bridge/createBridge.ts` (wiring), `messageHandler.ts` (origin check, guard, dispatch), `commandQueue.ts` (early commands), `listeners.ts`, React binding `useBridge.ts`                                                                                                                                                                                                                                                                                              |
