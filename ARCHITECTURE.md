...
| Concern                   | File                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Viewer side of the bridge | `packages/viewer-bridge/src/bridge.ts` (composition root), one `createViewerChannel` whose `onEach` map is checked against the contract with `satisfies` (A-22), `handshake.ts` (`VIEWER_READY`), `measurementStream.ts` (the three subscriptions), `reportedMeasurements.ts` (`uid ↔ rowId`, throttled updates), `commands.ts` (arming and tool control), `removals.ts`, `focus.ts`, `measurements.ts`, `throttle.ts`, `getCustomizationModule.tsx`, `restore.ts` (RESTORE_MEASUREMENTS, readiness gate, re-adding annotations), `geometry.ts`                    |
