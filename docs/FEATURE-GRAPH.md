...
| F-12 | Documentation: README, ARCHITECTURE, AI-USAGE | D-5, D-6, D-7, P-2, P-5, P-6 | F-11 | 6 `docs: README, ARCHITECTURE, AI-USAGE` | review | Fresh clone → both apps running by following README only; ARCHITECTURE has the diagram, full payload table and "Decisions"; AI-USAGE is honest and specific. |
