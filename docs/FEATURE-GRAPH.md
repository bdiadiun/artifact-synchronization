...
| F-16 | Bonus: focus annotation from row | S-5.3, C-4.4.2 | F-11 | 11 | review | Clicking a row highlights / jumps to the annotation. |
...
| 12+ | one branch per bonus node | F-17, F-19 |
