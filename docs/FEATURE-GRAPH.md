...
| F-11 | Total area with unit handling | C-4.3.8, Q-6, X-4 | F-10 | 5 `feat: total area calculation` | review | Sum is shown per unit (mm² and px² never added together); recalculates on every change; unit tests for the sum logic pass. |
