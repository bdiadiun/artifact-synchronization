...
| Field          | Value                                                                                                                                                                                                                                        |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current slice  | none open — slice 64 `refactor: a tool yields a list of metrics` (#87, decision A-40) is merged, published (contract 0.1.0, channel 0.0.10, scoring-viewer 0.1.2, ohif-extension-loader 0.1.2) and pinned in the fork                        |
| Gate           | — (next slice starts at gate 1)                                                                                                                                                                                                              |
| Last merged PR | `chore: pin the fork at the loader release 0.1.2` (slice 64 closed; fork at c361bf9b; before it #87)                                                                                                                                         |
| Next slice     | none — the repository was submitted on 2026-09-23; slice 64 came out of the defence rehearsal and this pin is the last change; anything after it (the study-change decision in Follow-ups, more tests) is optional and would start at gate 1 |
